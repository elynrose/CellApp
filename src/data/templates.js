...
export const TEMPLATES = {
  ...
  'newsletter-generator': {
    ...
    description:
      'Daily AI tech digest: research the web, draft sections, subject lines, header art, and optional email send (configure keys in Profile)',
    category: 'marketing',
    icon: '📰',
    cells: [
      {
        ...
        name: 'Theme & audience',
        prompt:
          'Define the newsletter focus for today.\n\nAudience: [audience]\nTone: [professional / casual]\nSections: [e.g. headlines, deep dive, tools]\nDate: [date]\n\nKeep it concise; downstream cards will research and write.',
        modelType: 'text',
      ...
      },
      {
        cellId: 'B1',
        cellReference: 'B1',
        name: 'Research (AI tech)',
        prompt:
          'Using the plan in {{A1}}, use web research to gather 5–8 current, credible stories or angles about artificial intelligence (product launches, models, regulation, research).\nOutput a markdown brief: title, 1–2 sentence summary, and source hint per item. Prefer items from the last 7 days when possible.',
        modelType: 'text',
        preferredModel: 'gpt-4o-mini',
        temperature: 0.5,
        characterLimit: 0,
      ...
      },
      {
        ...
        name: 'Draft issue',
        prompt:
          'Write the full newsletter body in markdown.\n\nUse the angle and sections from {{A1}} and weave in the research from {{B1}}.\nInclude: greeting, 3–4 story blocks with short takeaways, a "Tools & links" line, and sign-off. Keep scannable (headers, bullets).',
        modelType: 'text',
        preferredModel: 'gpt-4o',
        temperature: 0.7,
        characterLimit: 0,
      ...
      },
      {
        ...
        name: 'Subject lines',
        prompt:
          'From the draft in {{C1}}, propose 5 email subject lines (max ~60 chars each).\nOne line must feel urgent/newsy; one must feel analytical. Number them.',
        modelType: 'text',
        preferredModel: 'gpt-4o-mini',
        temperature: 0.8,
        characterLimit: 0,
      ...
      },
      {
        ...
        cellReference: 'B2',
        name: 'Header image',
        prompt: 'Editorial newsletter header image, wide banner, no text, subtle tech/AI mood, matches: {{A1}}',
        modelType: 'image',
        preferredModel: 'flux/dev',
        temperature: 0.7,
        characterLimit: 0,
      ...
      },
      {
        cellId: 'E1',
        cellReference: 'E1',
        name: 'Send digest (daily)',
        prompt:
          'Prepare one outgoing email for the list.\nUse subject line #1 from {{D1}} (or the strongest line if numbered list is unclear).\nBody: polished HTML or plain text version of {{C1}}; keep links readable.\nIf TOOL for email is available, send; otherwise output the exact email (To/Subject/Body) for manual paste.\nReference header art is in card B2 if you mention visuals.',
        modelType: 'text',
        preferredModel: 'gpt-4o-mini',
        temperature: 0.4,
        characterLimit: 0,
        ...
        interval: 0,
        enableTools: true,
        enabledTools: { tavily: false, email: true, telegram: false, twilioSms: false },
